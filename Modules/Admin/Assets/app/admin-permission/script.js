...
(function() {
    ...
    grid.setOptions({
        ...
        columns: [
            grid.helper.column.action([
                {
                    ...
                    text: 'Grant',
                    icon: 'user-plus',
                    click: 'grantPermission(event , this)',
                    display: 'icon-only'
                }
            ], {data: 'name'}),
            ...
            {title: 'Link', data: 'uri'},
            {
                title: 'Groups', data: 'groups', render: function(data, type, row) {
            ...
            {
                title: 'Users', data: 'users', render: function(data, type, row) {
                    return grid.helper.column.render.joinArray(',', data);
                },
            },
            {
                title: 'Banned Users', data: 'banned_users', render: function(data, type, row) {
                    return grid.helper.column.render.joinArray(',', data);
                },
            },
        ],

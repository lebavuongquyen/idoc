...
function init_sparklines() {
    ...
    $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5,
        4, 3, 5, 6], {
        type: 'bar',
        height: '125',
        barWidth: 13,
...
function init_wysiwyg() {
    ...
    function init_ToolbarBootstrapBindings() {
        ...
        $.each(fonts, function(idx, fontName) {
            fontTarget.append($(
                '<li><a data-edit="fontName ' + fontName + '" style="font-family:\'' + fontName + '\'">' + fontName + '</a></li>'));
        });
        $('a[title]').tooltip({
            container: 'body'
        });
        ...
        $('[data-role=magic-overlay]').each(function() {
            ...
            overlay.css('opacity', 0).css('position', 'absolute').offset(target.offset()).width(target.outerWidth()).
...
function init_daterangepicker_right() {
    ...
    $('#reportrange_right span').html(moment().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' + moment().format(
        'MMMM D, YYYY'));
    ...
    TabbedNotification = function(options) {
        ...
        if(! document.getElementById('custom_notifications')) {
            ...
            $('#custom_notifications ul.notifications').append(
                "<li><a id='ntlink" + cnt + "' class='alert-" + options.type + "' href='#ntf" + cnt + "'><i class='fa fa-bell animated shake'></i></a></li>");

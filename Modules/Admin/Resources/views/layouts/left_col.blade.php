<div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
        <a href="{{qurl('admin')}}" class="site_title"><i class="fa fa-paw"></i> <span>@yield('title')</span></a>
    </div>
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section">
            ...
            <ul class="nav side-menu">
                <li>
                    <a href="{{qurl('admin')}}"><i class="fa fa-home"></i> Home</a>
                </li>
                <li><a><i class="fa fa-hand-o-right"></i> Admin Permission <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="{{qurl('admin/admin-permission')}}">List</a></li>
                        <li><a href="{{qurl('admin/admin-permission/grant')}}">Grant</a></li>
                    </ul>
                </li>
                <li><a><i class="fa fa-users"></i> Users Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="{{qurl('admin/user')}}">List</a></li>
                        <li><a href="{{qurl('admin/role')}}">Roles</a></li>
                        <li><a href="{{qurl('admin/group')}}">Groups</a></li>
                    </ul>
                </li>

...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ qasset('/public/vendor/laravel-filemanager/img/folder.png') }}">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="{{ qasset('/public/vendor/laravel-filemanager/css/cropper.min.css') }}">
  <style>{!! \File::get(base_path('public/vendor/laravel-filemanager/css/lfm.css')) !!}</style>
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  {{-- <link rel="stylesheet" href="{{ qasset('public/vendor/laravel-filemanager/css/lfm.css') }}"> --}}
  <link rel="stylesheet" href="{{ qasset('/public/vendor/laravel-filemanager/css/mfb.css') }}">
...
<body>
  ...
  <script src="{{ qasset('/public/vendor/laravel-filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ qasset('/public/vendor/laravel-filemanager/js/jquery.form.min.js') }}"></script>
  <script>
